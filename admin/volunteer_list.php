...
<div id="content" >
  <div class="content-wrapper">
      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <tr>
				...
				<td id="ver" style="width:100px">
                    <a style="background-color:aqua" href='verify.php?id=<?php echo $row['donor_id']; 
					$row['donor_name']; 
					$row['donor_number'];
					$row['donor_mail'];
					$row['donor_age'];
	...
	<a href="volunteer_list_desc.php" target="_blank"> Click me to see top donors.....</a>
...
<div class="table-responsive"style="text-align:center;align:center">
    ...
    if(mysqli_num_rows($result1) > 0){
      ...
      if($page > 1){
        echo '<li><a href="volunteer_list.php?page='.($page - 1).'">Prev</a></li>';
      }
      for($i = 1; $i <= $total_page; $i++){
        ...
        echo '<li class="'.$active.'"><a href="volunteer_list.php?page='.$i.'">'.$i.'</a></li>';
      }
      if($total_page > $page){
        echo '<li><a href="volunteer_list.php?page='.($page + 1).'">Next</a></li>';
      }
