...
<div class="sidebar" ><b>
  ...
  <a href="volunteer_list.php"   <?php if($active=='list') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Volunteer List</a>
    <a href="donors_list.php"   <?php if($active=='list1') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Donors List</a>
    <a href="donor_list_desc.php"   <?php if($active=='list2') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Top Donors</a>

<a href="donor_request.php"   <?php if($active=='list3') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Request</a>
<a href="approved_donor_request.php"   <?php if($active=='list4') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Approved Request</a>
