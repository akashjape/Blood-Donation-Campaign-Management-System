...
<br>
        ...
        <div class="row">
          <?php
            include 'conn.php';
            $sql= "select * from campaign order by date limit 3";
            $result=mysqli_query($conn,$sql);
            if(mysqli_num_rows($result)>0)
            {
            while($row = mysqli_fetch_assoc($result)) {
           ?>
            ...
            <div class="card" style="width:300px">
                <img class="card-img-top" src="image\location.jpg" alt="Card image" style="width:100%;height:300px">
                <div class="card-body">
                <p class="card-text">
      <h3 class="card-title"><?php echo $row['location']; ?></h3>
      <p class="card-text">
        <b>Date : </b> <b><?php echo $row['date']; ?></b><br>
        <b>Time : </b> <?php echo $row['time']; ?><br><br>
        <a href = "donate_blood.php">
          <button class="button" style="background-color: #4CAF50; 
                                         border: none;
                                         color: white;
                                         padding: 15px 32px;
                                         text-align: center;
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#7FB3D5;color:#273746 ">Become a Donor </a>
				                <a class="btn btn-lg btn-secondary btn-block" href="admin/login.php" style="align:center; background-color:#7FB3D5;color:#273746 ">Admin Login </a>
            </div>
              <div>
